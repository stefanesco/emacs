;;; clj-refactor-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
(autoload 'cljr-undo-last-refactoring "clj-refactor" "\
...
lost; you're asked to confirm first." t)
...
(fn MODIFIER)")
 (autoload 'clj-refactor-menu "clj-refactor" nil t)
...
See: https://github.com/clojure-emacs/clj-refactor.el/wiki/cljr-require-macro" t)
(autoload 'cljr-stop-referring "clj-refactor" "\
Stop referring to vars in the namespace at point.

See: https://github.com/clojure-emacs/clj-refactor.el/wiki/cljr-stop-referring" t)
...
See: https://github.com/clojure-emacs/clj-refactor.el/wiki/cljr-move-form" t)
...
See: https://github.com/clojure-emacs/clj-refactor.el/wiki/cljr-extract-constant" t)
(autoload 'cljr-extract-def "clj-refactor" "\
Extract form at (or above) point as a def.
Create a def for it at the top level, and replace its current
occurrence with the defined name.

See: https://github.com/clojure-emacs/clj-refactor.el/wiki/cljr-extract-def" t)
...
See: https://github.com/clojure-emacs/clj-refactor.el/wiki/cljr-cycle-thread" t)
(autoload 'cljr-expand-let "clj-refactor" "\
Expand the let form above point by one level.

See: https://github.com/clojure-emacs/clj-refactor.el/wiki/cljr-expand-let" t)
...
See: https://github.com/clojure-emacs/clj-refactor.el/wiki/cljr-destructure-keys" t)
...
See: https://github.com/clojure-emacs/clj-refactor.el/wiki/cljr-project-clean" t)
(autoload 'cljr-sort-project-dependencies "clj-refactor" "\
Sorts all dependency vectors in `project.clj'.

See: https://github.com/clojure-emacs/clj-refactor.el/wiki/cljr-sort-project-dependencies" t)
...
See: https://github.com/clojure-emacs/clj-refactor.el/wiki/cljr-update-project-dependencies" t)
...
(fn PROMOTE-TO-DEFN)" t)
(autoload 'cljr-find-usages "clj-refactor" "\
Find all usages of the symbol at point in the project.

See: https://github.com/clojure-emacs/clj-refactor.el/wiki/cljr-find-usages" t)
...
See: https://github.com/clojure-emacs/clj-refactor.el/wiki/cljr-clean-ns" t)
...
See: https://github.com/clojure-emacs/clj-refactor.el/wiki/cljr-add-missing-libspec" t)
...
See: https://github.com/clojure-emacs/clj-refactor.el/wiki/cljr-hotload-dependency" t)
(autoload 'cljr-extract-function "clj-refactor" "\
Extract the form at (or above) point as a top-level defn.

See: https://github.com/clojure-emacs/clj-refactor.el/wiki/cljr-extract-function" t)
(autoload 'cljr-add-stubs "clj-refactor" "\
Adds implementation stubs for the interface or protocol at point.

See: https://github.com/clojure-emacs/clj-refactor.el/wiki/cljr-add-stubs" t)
(autoload 'cljr-inline-symbol "clj-refactor" "\
Inline the symbol at point.

See: https://github.com/clojure-emacs/clj-refactor.el/wiki/cljr-inline-symbol" t)
(autoload 'cljr-version "clj-refactor" "\
Returns the version of the middleware as well as this package." t)
(autoload 'cljr-toggle-debug-mode "clj-refactor" nil t)
...
See: https://github.com/clojure-emacs/clj-refactor.el/wiki/cljr-create-fn-from-example" t)
...
See: https://github.com/clojure-emacs/clj-refactor.el/wiki/cljr-change-function-signature" t)
...
(with-eval-after-load 'cider (cljr--inject-jack-in-dependencies))
(autoload 'clj-refactor-mode "clj-refactor" "\
A mode to keep the clj-refactor keybindings.

This is a minor mode.  If called interactively, toggle the `Clj-Refactor
...
evaluate the variable `clj-refactor-mode'.

The mode's hook is called both when the mode is enabled and when it is
disabled.

(fn &optional ARG)" t)
(register-definition-prefixes "clj-refactor" '("*cljr--noninteractive*" "clj"))

;;; End of scraped data
